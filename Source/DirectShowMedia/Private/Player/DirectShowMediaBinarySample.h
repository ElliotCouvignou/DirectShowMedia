...
/**
 * Implements a media binary data sample for DirectShowMedia.
 */
class FDirectShowMediaBinarySample
	: public IMediaBinarySample
{
public:

	/** Default constructor. */
	FDirectShowMediaBinarySample()
		: Duration(FTimespan::Zero())
		, Time(FTimespan::Zero())
	{ }

	/** Virtual destructor. */
	virtual ~FDirectShowMediaBinarySample() { }
