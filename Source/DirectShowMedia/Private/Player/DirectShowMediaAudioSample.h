...
/**
 * Implements a media audio sample for DirectShowMedia.
 */
class FDirectShowMediaAudioSample
...
public:
	...
	/** Virtual destructor. */
	virtual ~FDirectShowMediaAudioSample() { }
...
/** Implements a pool for DirectShow audio sample objects. */
class FDirectShowMediaAudioSamplePool : public TMediaObjectPool<FDirectShowMediaAudioSample> { };
