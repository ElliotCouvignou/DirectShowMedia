...
/**
 * Implements an overlay text sample for DirectShowMedia.
 */
class FDirectShowMediaOverlaySample
	: public IMediaOverlaySample
{
public:

	/** Default constructor. */
	FDirectShowMediaOverlaySample()
		: Duration(FTimespan::Zero())
		, Time(FTimespan::Zero())
	{ }

	/** Virtual destructor. */
	virtual ~FDirectShowMediaOverlaySample() { }
