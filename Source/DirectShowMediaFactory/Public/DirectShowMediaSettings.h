...
#include "DirectShowMediaSettings.generated.h"


/**
 * Settings for the DirectShowMedia plug-in.
 */
UCLASS(config=Engine, defaultconfig)
class DIRECTSHOWMEDIAFACTORY_API UDirectShowMediaSettings
	: public UObject
{
	GENERATED_BODY()
